package com.example.ycl.mygank.api;

import com.example.ycl.mygank.Config;
import com.example.ycl.mygank.converter.string.StringConverterFactory;
...
public interface API {
     ...
     * @return
     * @see com.example.ycl.mygank.bean.DataInfo
     */
     ...
     * @param day   日
     * @return
     * @see com.example.ycl.mygank.bean.DayInfo
     */
     ...
     *
     * @return
     * @see com.example.ycl.mygank.bean.HistoryInfo
     */
    @GET("day/history")
     ...
     * @return
     * @see com.example.ycl.mygank.bean.HistoryDataInfo
     */
